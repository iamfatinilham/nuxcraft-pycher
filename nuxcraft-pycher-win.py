...
try:
    ...
    def is_allowed(rules):
        # Strict Windows filtering for libraries.
    ...
    if args.offline or os.path.exists(integrity_marker):
        ...
        for attempt in range(max_retries):
            ...
            if not missing:
                ...
                print(f"[ ⚠️️ ] \033[1;93mWarning:\033[0m {len(missing)} file/s failed to download or are corrupt:")
                for m in missing[:15]: # Log first 15 missing files to stdout
                    print(f" - {os.path.basename(m)}")
                if len(missing) > 15: print(f" ... and {len(missing)-15} more.")
    
                if attempt < max_retries - 1:
                    print("[ ⚠️️ ] \033[1;93mRetrying missing files in 5 seconds...\033[0m")
                    time.sleep(5)
    ...
    def build_cmd():
        ...
        if has_large_pages_privilege():
            if not args.disable_large_pages:
                ...
                print("\n[ ✅ ] \033[1;92mLarge Pages detected & enabled.\033[0m")
            else:
                print("\n[ ℹ️ ] \033[1;96mLarge Pages\033[1;97m has been disabled by the user.\033[0m")
        else:
            print("\n[ ℹ️ ] \033[1;97mNOTE: \033[1;96mLarge Pages\033[1;97m not available to use or, is disabled (\033[1;91mRequires Admin/GPO\033[1;97m).\033[0m\n", 
                  "      \033[1;97mFor optimal performance, consider enabling \033[1;96mLarge Pages\033[1;97m on your system (\033[1;96mOptional\033[1;97m).\033[0m\n")
